resolved = [
     ...
     },
     {
          ...
          "definition_information": "Repository hermetic_cc_toolchain instantiated at:\n  /Volumes/VAULTROOM/rules_graalvm/WORKSPACE.bzlmod:57:13: in <toplevel>\nRepository rule http_archive defined at:\n  /private/var/tmp/_bazel_sam/096d0fb8d9b4b97d25f3c6f4e987e69a/external/bazel_tools/tools/build_defs/repo/http.bzl:379:31: in <toplevel>\n",
          "original_attributes": {
          ...
          "repositories": [
               {
                    ...
                    "output_tree_hash": "25b326b0edc1ccab6cb3ff079e462ea7aa9ea19761619785eef10587417278aa"
               }
          ]
     },
     {
     ...
     {
          "original_rule_class": "@rules_jvm_external~5.3//:coursier.bzl%pinned_coursier_fetch",
          "definition_information": "Repository rules_jvm_external~5.3~maven~maven_gvm instantiated at:\n  <builtin>: in <toplevel>\nRepository rule pinned_coursier_fetch defined at:\n  /private/var/tmp/_bazel_sam/096d0fb8d9b4b97d25f3c6f4e987e69a/external/rules_jvm_external~5.3/coursier.bzl:1166:40: in <toplevel>\n",
          "original_attributes": {
               "name": "rules_jvm_external~5.3~maven~maven_gvm",
               "repositories": [
                    "{ \"repo_url\": \"https://maven.pkg.st\" }",
                    "{ \"repo_url\": \"https://maven.google.com\" }",
                    "{ \"repo_url\": \"https://repo1.maven.org/maven2\" }"
               ],
               "artifacts": [
                    "{ \"group\": \"org.graalvm.nativeimage\", \"artifact\": \"svm\", \"version\": \"23.0.1\" }",
                    "{ \"group\": \"org.graalvm.sdk\", \"artifact\": \"graal-sdk\", \"version\": \"23.0.1\" }"
               ],
               "fetch_sources": True,
               "fetch_javadoc": False,
               "generate_compat_repositories": False,
          ...
          "repositories": [
               {
                    ...
                    "output_tree_hash": "6b3a79c657853069f9cfaf0ce8215de5156c722ae91f9b8e4969c05741b358e5"
               }
          ]
     },
     {
